...
- Parser, legality, and emission support for the admitted channel-contract
  syntax.
- Any required AST/schema and interface-summary evolution, versioned
  explicitly rather than smuggled into PR11.8b's proof claim.
- Corpus, docs, and tooling updates that define the admitted syntax boundary
  without altering PR11.8b's checkpoint scope retroactively.
