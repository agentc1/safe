...
Current implementation note: the compiler now ships the core non-channel PR11.8d
surface end-to-end. Today:
...
- string iteration, string `case`, string discriminants, proof-based exact
  length narrowing, and string/growable channel elements remain deferred
